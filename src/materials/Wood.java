...
public class Wood extends HallMaterial {
...
//		
//		
//		Double t = ImprovedNoise.noise(point.getX(), 
//									   point.getY(),
//									   point.getZ());
//		
//		System.out.println(t);
//		
////		double noiseCoef = t - t.intValue();
////		double ft = Math.PI*noiseCoef;
////		double f = (1-Math.cos(ft))*0.5;
////		result = color.times(1-f).plus(color2.times(f));
//		
////		System.out.println(t);
////		System.out.println(noiseCoef);
////		System.out.println(result);
//		
//		
//		return luminance.times(this.ambientReflectanceCoefficient).times(color.times(Math.abs(t)));
//		
//		
//	}
...
//		double f = (1-Math.cos(ft))*0.5;
//		f = Math.abs(f);
//		return color.times(1-f).plus(color2.times(f));
